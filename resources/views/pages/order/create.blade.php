            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <table>
                    <tr><td><b>&nbsp;&nbsp;&nbsp; Sales ID:</b></td><td><input type="text" style="width:60px" value="<?php //echo Order::getLastOrderId()+1;?>"  readonly/></td></tr>
                  ...
                  <address>
                    ...
                    ?>
                    <b>customer:</b> <select id="cmbCustomer" name="cmbCustomer">
